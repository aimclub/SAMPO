...
def test_work_graph_csv_parser():
    try:
        wg, contractors = CSVParser.work_graph_and_contractors(os.path.dirname(os.path.realpath(__file__)) + '\\test_work_graph.csv',
                                                               contractor_info=os.path.dirname(os.path.realpath(__file__)) + '\\test_contractors.csv')
