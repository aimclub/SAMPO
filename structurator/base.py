...
from schemas.graph import GraphNode, GraphNodeDict, GraphEdge, WorkGraph, EdgeType
...
def node_restructuring(origin_node: GraphNode, id2new_nodes: GraphNodeDict,
    ...
    for ind in range(len(proportions)):
        ...
        reqs = [WorkerReq(wr.type, wr.volume * piece_div_main, wr.min_count, wr.max_count)
