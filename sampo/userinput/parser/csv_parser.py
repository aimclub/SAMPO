...
class CSVParser:
    ...
    def work_graph_and_contractors(project_info: str,
        ...
        :param work_resource_estimator: work estimator that finds necessary resources, based on history data
        ...
        if contractor_info is None and isinstance(work_resource_estimator, DefaultWorkEstimator):
            raise InputDataException(
                'you have neither info about contractors nor work resource estimator.'
            )
        elif contractor_info is None:
        ...
        # if we have no info about contractors or user receive empty .csv file
