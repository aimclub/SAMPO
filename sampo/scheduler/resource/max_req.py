...
class MaxReqResourceOptimizer(ResourceOptimizer):
    """
    Class that implements optimization the number of resources by assigning maximal resource requirements.
    """
    ...
    def optimize_resources(self,
        ...
        """
        The resource optimization module, that counts maximal resource requirements.
